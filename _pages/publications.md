...
<div class="col-md-10 col-sm-12 col-xs-12">
 ...
 {{ publi.authors | replace_first: 'Anton Nedelin', '<b>Anton Nedelin</b>'}}<br/>
 {{ publi.authors | replace_first: 'A.Nedelin', '<b>A.Nedelin</b>'}}<br/>
 ...
 {% if publi.arxiv %}<a href="https://arxiv.org/abs/{{ publi.arxiv }}" target="_blank"><button type="button" class="btn btn-sm btn-primary">ARXIV</button></a> {% endif %}
...
<div class="col-md-10 col-sm-12 col-xs-12">
  <b>{{ publi.title }}</b><br/>
  {{ publi.authors | replace_first: 'A.Nedelin', '<b>A.Nedelin</b>' | replace_first: 'Anton Nedelin', '<b>Anton Nedelin</b>'}}<br/>
